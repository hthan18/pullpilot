...
export default function Login() {
  ...
  return <main className="login-page">
    ...
    <section className="login-panel"><div className="login-card"><p className="eyebrow">Developer workspace</p><h2>Continue to PullPilot</h2><p>Connect your GitHub account to review pull requests across your repositories.</p><button className="github-button" onClick={signIn} disabled={loading || checking}><span>●</span>{loading ? 'Connecting…' : checking ? 'Checking session…' : 'Continue with GitHub'}</button><div className="login-features"><span>✓ Read-only repository discovery</span><span>✓ Encrypted GitHub credentials</span><span>✓ Evidence-backed AI findings</span></div><small>By continuing, you authorize PullPilot to access the repositories permitted by your GitHub account.</small></div></section>
  </main>;
}
