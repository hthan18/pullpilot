    ...
    <div style={{ minHeight: '100vh', background: '#111827' }}>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', marginBottom: '32px' }}>
          <div style={{ background: '#1f2937', borderRadius: '8px', padding: '24px', border: '1px solid #374151' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <p style={{ color: '#9ca3af', fontSize: '14px', margin: 0 }}>Connected Repos</p>
                <p style={{ fontSize: '30px', fontWeight: 'bold', color: 'white', marginTop: '4px', marginBottom: 0 }}>
                  {repos.filter(r => r.is_active).length}
                </p>
              </div>
              <div style={{ background: '#2563eb', borderRadius: '50%', padding: '12px', width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ background: '#1f2937', borderRadius: '8px', padding: '24px', border: '1px solid #374151' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <p style={{ color: '#9ca3af', fontSize: '14px', margin: 0 }}>Total Reviews</p>
                <p style={{ fontSize: '30px', fontWeight: 'bold', color: 'white', marginTop: '4px', marginBottom: 0 }}>0</p>
              </div>
              <div style={{ background: '#10b981', borderRadius: '50%', padding: '12px', width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg style={{ width: '24px', height: '24px', color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div style={{ background: '#1f2937', borderRadius: '8px', padding: '24px', border: '1px solid #374151' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <p style={{ color: '#9ca3af', fontSize: '14px', margin: 0 }}>Issues Found</p>
                <p style={{ fontSize: '30px', fontWeight: 'bold', color: 'white', marginTop: '4px', marginBottom: 0 }}>0</p>
              </div>
              <div style={{ background: '#f59e0b', borderRadius: '50%', padding: '12px', width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg style={{ width: '24px', height: '24px', color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div style={{ padding: '24px' }}>
            {repos.filter(r => r.is_active).length === 0 ? (
              <div style={{ textAlign: 'center', padding: '48px 0' }}>
                <svg style={{ width: '64px', height: '64px', color: '#4b5563', margin: '0 auto 16px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                </svg>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {repos.filter(r => r.is_active).map((repo) => (
                  <div key={repo.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', background: '#111827', borderRadius: '8px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                      <div style={{ background: '#374151', borderRadius: '50%', padding: '8px', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
